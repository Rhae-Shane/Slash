...
<html lang="en">
  <head>
    ...
    <title>URL Shortener - API Explorer</title>
  ...
  <body>
    <div class="header">
      ...
      <div class="header-buttons">
        <button id="user-routes" type="button">User Routes</button>
        <button id="admin-routes" type="button">Admin Routes</button>
      </div>
    </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        const userRoutesBtn = document.getElementById("user-routes");
        const adminRoutesBtn = document.getElementById("admin-routes");
        ...
        userRoutesBtn.addEventListener("click", function () {
          window.location.href = window.location.origin + "/api-docs";
        });

        adminRoutesBtn.addEventListener("click", function () {
          window.location.href = window.location.origin + "/api-docs";
        });
      });
    </script>
...
export function mountSwagger(app: Express): void {
  // Built from Zod schemas on each process start so docs stay in sync
